  ...
  return (
    ...
    >
      ...
      <div className="content-wrapper">
        <h2>{title}</h2>
        <p>{description}</p>
        <Link to={link} className="about-link" aria-label={`Learn more about ${title}`}>
...
const About = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      description: 'Explore our safe, nurturing spaces designed for discovery and growth.',
    ...
    },
    {
      ...
      description: 'Discover the engaging activities that make learning fun and memorable.',
      link: '/activities',
    },
  ];
