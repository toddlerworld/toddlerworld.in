            ...
            <div className='kindergarten1-container'>
                <div className='left-aligned-kindergarten1'>
                    <p>
                        ...
                        This program is meant for children between 4 years to 5 years old. In Kindergarten 1 we focus
                        on skills that will guide your child towards future academic success. The learning tenets of the
                        program include social finesse and mastering gross motor skills. Each school day we provide your
