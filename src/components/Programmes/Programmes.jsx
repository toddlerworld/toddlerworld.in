  ...
  return (
    <div className="programmes-container" data-testid="programmes-container">
      ...
      >
        ...
        <p>
          Our programmes are designed keeping in mind your child's age and ability to absorb
          information. We make sure to provide your child with every opportunity to challenge
          themselves while also paying equal attention to keeping them fit and active. Our
          activities are not only confined to the classroom but also include various other
      ...
      >
        ...
        <p>
          Our programmes are meticulously crafted to align with the developmental milestones of your
          child. We strive to create an environment where they can thrive intellectually, physically
          and emotionally. Beyond traditional classroom settings, we offer a diverse range of
          activities aimed at making learning a joyous and holistic experience.
        </p>
      </motion.div>
    </div>
  );
