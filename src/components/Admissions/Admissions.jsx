    ...
    <div className="admissions-container" data-testid="admissions-container">
      ...
      >
        <div className="left-aligned-admissions">
          <p>
            Parents are encouraged to visit the nursery in person and have a feel of the
            environment.
          </p>
          <ul>
            ...
            <li>
              ...
              procedures and formalities and pay the required fee within a stipulated time. Once all
              the formalities are completed the admission is deemed to be confirmed.
            </li>
          </ul>
        </div>
        ...
        <div className="right-aligned-admissions">
          <h1>Learn More</h1>
          <p>
            Our admissions process adheres to the equitable principle of serving individuals on a
            first-come, first-served basis, ensuring a fair and timely allocation of opportunities.
            To initiate your enrollment journey, kindly click on the button below, where you can
          ...
          <div className="register-interest-admission" data-testid="register-test-comp">
            ...
            >
              <Button buttonStyle="primary-button" buttonSize="large" data-testid="register-test">
                Submit an Enquiry
              </Button>
            </Link>
          </div>
